...
function InterviewCard({ interview, viewDetail=false }) {
    ...
    const onSend = () => {
        window.location.href="mailto:11231013@student.itk.ac.id?subject=Recruitbot Interview Link & body=Interview Link:" + url
    }
    ...
    return (
        <div className='p-5 bg-white rounded-lg border'>
            ...
            {!viewDetail? <div className='grid grid-cols-2 gap-3 mt-5'>
